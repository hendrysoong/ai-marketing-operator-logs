# Operator Logs — Agent Entry Point
...
## Routing
- For system overview: read [README.md](../README.md)
- For current engine versions: read [SYSTEM-STATUS.md](../SYSTEM-STATUS.md)
- For principles and patterns: read [PRINCIPLES.md](../PRINCIPLES.md)
- For a specific engine's history: read [engine-name]/CHANGELOG.md
- For full retrospectives: read files in deep-dives/
